...
<br>`
                for (var i = 0; i < length; i++){
                    finalHTML +=   `
                    <div class="col s3 m3">    
                      <div class="card red darken-4 medium">
                        ...
                        <div class="card-action">
                          <a class = "white-text" href="${json.nearby_restaurants[i].restaurant.menu_url}" target = "_blank">See the full menu  <i class="material-icons white-text">open_in_new</i></a>
                        </div>
                      </div>
                    </div>`
                }
