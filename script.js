                    ...
                    <div class="col s3 m3">    
                      <div class="card red darken-4 medium">
                        ...
                        <div class="card-action">
                          <a class = "white-text" href="${json.nearby_restaurants[i].restaurant.menu_url}" target = "_blank">See the full menu &emsp;&emsp; <i class="material-icons">open_in_new</i></a>
                        </div>
                      </div>
                    </div>`
                }
